...
rotatechange = 0.1
speedchange = 0.05
waypoints = pickle.load(open("poses.pickle", "rb"))

class Navigation(Node):

    #global get_waypoint
    #get_waypoint = lambda x: (waypoints[x].pose.pose.position.x, waypoints[x].pose.pose.position.y)
    ...
    def get(self, cp):
        ...
        while cp != 0:
            ...
            #pose.pose.position.x = get_waypoint(num)[0]
