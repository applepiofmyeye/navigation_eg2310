#!/usr/bin/env python3  2 # this gets the twist object and publishes to mqtt
...
# from geometry_msgs.msg import Point, Pose, Quaternion, Vector3 24 # from std_msgs.msg import Int32, Float32
...
# code from https://automaticaddison.com/how-to-convert-a-quaternion-into-e    uler-angles-in-python/
...
class RelayRos2Mqtt2(Node):
    def __init__(self):
        super().__init__('relay_ros2_mqtt_2')
        ...
        self.SHORTEST_PUB_TOPIC = self.declare_parameter("~shortest_pub_topic", 'help').value
        ...
        self.ROS_SCAN_SUB_TOPIC = self.declare_parameter("~scan_sub_topic", 'scan').value
        self.ROS_ODOM_SUB_TOPIC = self.declare_parameter("~odom_sub_topic", 'odom').value
        ...
        self.get_logger().info(f'relay_ros2_mqtt:: SHORTEST_PUB_TOPIC = {self.SHORTEST_PUB_TOPIC}')
    ...
    def listener_callback(self, msg):
        self.get_logger().info('in listener_callback')
        # create numpy array
        ...
        # log the info
        info = 'Shortest distance at %i degrees' % int(lr2i)

        msg = String()
        msg.data = "help"

        self.mqttclient.publish(self.SHORTEST_PUB_TOPIC, 'help', qos=0, retain=False)
...
def main(args=None):
    ...
    try:
        relay_ros2_mqtt_2 = RelayRos2Mqtt2()
        rclpy.spin(relay_ros2_mqtt_2)
